...
public class ChuongTrinhGiamGiaHoaDonController {
    ...
    private final ChuongTrinhGiamGiaHoaDonService serviceHD;
    private final ChuongTrinhGiamGiaChiTietHoaDonService serviceCTHD;

    private ChuongTrinhGiamGiaHoaDon ctggHD = new ChuongTrinhGiamGiaHoaDon();

    public ChuongTrinhGiamGiaHoaDonController(ChuongTrinhGiamGiaHoaDonService serviceHD, ChuongTrinhGiamGiaChiTietHoaDonService serviceCTHD) {
        this.serviceHD = serviceHD;
        this.serviceCTHD = serviceCTHD;
    }
