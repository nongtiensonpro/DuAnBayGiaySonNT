...
import sonnt.service.admin.HuongDanBaoQuanService;
...
public class HuongDanBaoQuanController {
    ...
    private final HuongDanBaoQuanService huongDanBaoQuanService;
    private final HuongDanBaoQuanRepository huongDanBaoQuanRepository;
    ServletContext context;

    public HuongDanBaoQuanController(HuongDanBaoQuanService huongDanBaoQuanService, HuongDanBaoQuanRepository huongDanBaoQuanRepository) {
        this.huongDanBaoQuanService = huongDanBaoQuanService;
