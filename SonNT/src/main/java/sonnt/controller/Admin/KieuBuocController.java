...
import sonnt.service.admin.KieuBuocService;
...
public class KieuBuocController {
    ...
    private final KieuBuocService kieuBuocService;

    public KieuBuocController(KieuBuocRepository kieuBuocRepository, KieuBuocService kieuBuocService) {
        this.kieuBuocRepository = kieuBuocRepository;
        this.kieuBuocService = kieuBuocService;
    }
