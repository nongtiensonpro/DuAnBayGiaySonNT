...
import sonnt.service.admin.LotGiayService;
...
public class LotGiayController {
    ...
    private final LotGiayService lotGiayService;
    private final LotGiayRepository lotGiayRepository;
    ServletContext  context;
    public LotGiayController(LotGiayService lotGiayService, LotGiayRepository lotGiayRepository, ServletContext context) {
        this.lotGiayService = lotGiayService;
