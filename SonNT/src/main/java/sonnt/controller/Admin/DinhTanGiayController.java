...
import sonnt.service.admin.DinhTanGiayService;
...
public class DinhTanGiayController {
    ...
    private final DinhTanGiayService dinhTanGiayService;

    public DinhTanGiayController(DinhTanGiayRepository dinhTanGiayRepository, DinhTanGiayService dinhTanGiayService) {
        this.dinhTanGiayRepository = dinhTanGiayRepository;
        this.dinhTanGiayService = dinhTanGiayService;
    }
