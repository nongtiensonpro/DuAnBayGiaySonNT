...
import sonnt.service.admin.CongDungService;
...
public class CongDungController {
    ...
    public CongDungController(CongDungRepository congDungRepository, CongDungService congDungService) {
        this.congDungRepository = congDungRepository;
        this.congDungService = congDungService;
    }
