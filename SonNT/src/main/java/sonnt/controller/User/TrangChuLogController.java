...
public class TrangChuLogController {
    ...
    public TrangChuLogController(UserServiceImpl userServiceImpl, UserRepository userRepository, ServletContext context, JavaMailSender mailSender) {
