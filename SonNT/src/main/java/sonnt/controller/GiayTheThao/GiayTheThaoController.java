package sonnt.controller.GiayTheThao;
...
public class GiayTheThaoController {
    ...
    public GiayTheThaoController(FormRepository formRepository, CongDungRepository congDungRepository, ChatLieuRepository chatLieuRepository, HuongDanBaoQuanRepository huongDanBaoQuanRepository, LotGiayRepository lotGiayRepository, CoGiayRepository coGiayRepository, DeGiayRepository deGiayRepository, DayGiayRepository dayGiayRepository, TrongLuongRepository trongLuongRepository, ThuongHieuRepository thuongHieuRepository, KieuBuocRepository kieuBuocRepository, DinhTanGiayRepository dinhTanGiayRepository, GiayTheThaoRepository giayTheThaoRepository, GiayTheThaoChiTietRepository giayTheThaoChiTietRepository, ImageRepository imageRepository, SizeRepository sizeRepository, MauSacRepository mauSacRepository, GiayTheThaoService giayTheThaoService) {
        ...
        this.giayTheThaoService = giayTheThaoService;
    }
