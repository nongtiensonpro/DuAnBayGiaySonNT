...
import sonnt.repository.ChuongTrinhGiamGia.ChuongTrinhGiamGiaGiayTheThaoRepository;
import sonnt.repository.SanPham.GiayTheThao.GiayTheThaoRepository;
import sonnt.service.impl.ChuongTrinhGiamGiaGiayTheThaoImpl;
...
public class ChuongTrinhGiamGiaGiayTheThaoService implements ChuongTrinhGiamGiaGiayTheThaoImpl {
    ...
    private final ChuongTrinhGiamGiaGiayTheThaoRepository repo;


    private final GiayTheThaoRepository gttrepo;


    private ChuongTrinhGiamGiaChiTietGiayTheThaoService ctggChiTiet;

    public ChuongTrinhGiamGiaGiayTheThaoService(ChuongTrinhGiamGiaGiayTheThaoRepository repo, GiayTheThaoRepository gttrepo, ChuongTrinhGiamGiaChiTietGiayTheThaoService serviceCTSP) {
        this.repo = repo;
        this.gttrepo = gttrepo;
        this.serviceCTSP = serviceCTSP;
    }
    ...
    private final ChuongTrinhGiamGiaChiTietGiayTheThaoService serviceCTSP;
