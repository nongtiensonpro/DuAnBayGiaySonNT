...
public class HoaDonService implements HoaDonServiceImpl{
    ...
    public HoaDonService(HoaDonChiTietRepository hdctRepo, KhachHangRepository khRepo, GiayTheThaoChiTietRepository gttctRepo, HoaDonRepository hoaDonRepository) {
        this.hdctRepo = hdctRepo;
        this.khRepo = khRepo;
        this.gttctRepo = gttctRepo;
    ...
    private final GiayTheThaoChiTietRepository gttctRepo;
