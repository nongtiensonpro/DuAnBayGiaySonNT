...
import sonnt.service.impl.ChuongTrinhGiamGiaChiTietGiayTheThaoImpl;
...
public class ChuongTrinhGiamGiaChiTietGiayTheThaoService implements ChuongTrinhGiamGiaChiTietGiayTheThaoImpl {
    ...
    private final ChuongTrinhGiamGiaChiTietGiayTheThaoRepository repo;

    public ChuongTrinhGiamGiaChiTietGiayTheThaoService(ChuongTrinhGiamGiaChiTietGiayTheThaoRepository repo) {
        this.repo = repo;
    }
