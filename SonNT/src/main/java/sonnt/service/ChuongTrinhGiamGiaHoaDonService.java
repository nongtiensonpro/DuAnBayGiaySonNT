...
import sonnt.repository.ChuongTrinhGiamGia.ChuongTrinhGiamGiaHoaDonRepository;
...
public class ChuongTrinhGiamGiaHoaDonService implements ChuongTrinhGiamGiaHoaDonImpl {
    ...
    private final ChuongTrinhGiamGiaHoaDonRepository repo;

    public ChuongTrinhGiamGiaHoaDonService(ChuongTrinhGiamGiaHoaDonRepository repo) {
        this.repo = repo;
    }
